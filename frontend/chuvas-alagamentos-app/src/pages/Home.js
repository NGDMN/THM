...
const Home = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4, mb: 8 }}>
      <Typography variant="h4" component="h1" gutterBottom sx={{ color: '#1B4F72', fontFamily: 'Neue Haas Grotesk, Arial, sans-serif', fontWeight: 700, fontSize: '3rem', lineHeight: 1.2 }}>
        Sistema de Previsão de Alagamentos RJ/SP
      </Typography>
      <Typography variant="subtitle1" color="text.secondary" paragraph sx={{ fontFamily: 'Neue Haas Grotesk, Arial, sans-serif', fontSize: '1.25rem', lineHeight: 1.5 }}>
        Monitoramento inteligente de chuvas e alagamentos nas regiões metropolitanas do Rio de Janeiro e São Paulo.
      </Typography>
      <Box sx={{ mb: 4, background: '#F5F9FC', borderRadius: 2, p: 3, boxShadow: 1 }}>
        <Typography variant="h5" sx={{ color: '#CB6D51', fontFamily: 'Neue Haas Grotesk, Arial, sans-serif', fontWeight: 600, mb: 2 }}>
          Sobre o Projeto
        </Typography>
        <Typography sx={{ fontFamily: 'Neue Haas Grotesk, Arial, sans-serif', fontSize: '1rem', lineHeight: 1.5, mb: 2 }}>
        ...
        <Typography variant="h6" sx={{ color: '#1B4F72', fontFamily: 'Neue Haas Grotesk, Arial, sans-serif', fontWeight: 500, mb: 1 }}>
          Metodologia
        </Typography>
        <ul style={{ marginLeft: '1.5rem', marginBottom: '1.5rem', color: '#1B4F72', fontFamily: 'Neue Haas Grotesk, Arial, sans-serif' }}>
        ...
        <ul style={{ marginLeft: '1.5rem', color: '#1B4F72', fontFamily: 'Neue Haas Grotesk, Arial, sans-serif' }}>
